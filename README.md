...
![ProofPort sample workspace](./docs/product-workspace.png)
...
proofport actions
proofport workspace
proofport page '{"limit":50,"state":"active","search":"Title prefix"}'
proofport detail '00000000-0000-4000-8000-000000000001'
...
```bash
docker build -t proofport:0.3.1 .
